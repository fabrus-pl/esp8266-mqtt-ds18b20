...
{
 if (month<4 || month>9) return true; // Daylight savings in Jan, Feb, Mar, Oct Nov, Dec
 if (month>4 && month<9) return false; // No daylight savings in Apr, Mai, Jun, Jul, Aug, Sep
